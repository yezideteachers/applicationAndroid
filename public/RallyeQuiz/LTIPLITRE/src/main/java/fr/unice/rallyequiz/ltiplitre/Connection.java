  ...
  /* Enregistrement des préférences */
    ...
    /* Clic sur le bouton Login */
        ...
        /* On construit la liste des paramètres de la requête */
                ...
                nameValuePairs.add(new BasicNameValuePair("tag", "connection"));
          ...
          /* Exécute la requête vers le serveur local */
                    ...
                    HttpPost httppost = new HttpPost("http://10.0.2.2/android_login_api/index.php");   // IMPORTANT ici localhost = 10.0.2.2
